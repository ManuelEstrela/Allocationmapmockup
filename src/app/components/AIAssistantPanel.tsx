    ...
    <div className="fixed inset-y-0 right-0 w-[480px] bg-white shadow-2xl z-50 flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-6 py-6">
        <div className="space-y-4">
          <div>
            <Label className="text-sm font-medium text-gray-700">Allocation Request</Label>
          ...
          <div className="space-y-4">
            <div>
              <Label htmlFor="role">Resource Types</Label>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label htmlFor="initiationWeeks">Initiation Weeks</Label>
                <Input
                  id="initiationWeeks"
                  type="number"
              ...
              <div>
                <Label htmlFor="allocationPercent">Initiation Allocation (%)</Label>
                <Input
            ...
            <div className="pt-2">
              ...
              <div className="mt-3 space-y-3">
                <div>
                  <Label htmlFor="initial" className="text-xs text-gray-600">Initial</Label>
                ...
                <div>
                  <Label htmlFor="mid" className="text-xs text-gray-600">Mid</Label>
                  <div className="flex items-center gap-3 mt-1">
                    <Input
                      id="mid"
                      type="number"
                ...
                <div>
                  <Label htmlFor="final" className="text-xs text-gray-600">Final</Label>
                  <div className="flex items-center gap-3 mt-1">
                    <Input
                      id="final"
                      type="number"
          ...
          <Button
            ...
            className="w-full bg-[#a3c9ea] hover:bg-[#8db8df] text-gray-900"
          >
            {isGenerating ? (
              <>
                ...
                {candidates.map((candidate, index) => (
                  ...
                  >
                        ...
                        {candidate.availabilityConflicts.length > 0 && (
                          <div className="mt-2 pt-2 border-t border-gray-100">
                            ...
                            {candidate.availabilityConflicts.map((conflict, idx) => (
                              <p key={idx} className="text-xs text-[#ff534c] ml-4">• {conflict}</p>
                            ))}
                          </div>
                        )}
                      </div>
                    ...
                    <div className="mt-3 flex gap-2">
                      <Button size="sm" className="flex-1 bg-[#ff534c] hover:bg-[#e64840] text-white">
                        Assign
                      </Button>
